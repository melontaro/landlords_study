...
namespace ETModel
{
	public static partial class OuterOpcode
	{
		 ...
		 public const ushort Actor_GamerPlayCard_Ntt = 125;
		 public const ushort Actor_GamerPrompt_Req = 126;
		 public const ushort Actor_GamerPrompt_Back = 127;
		 public const ushort Actor_AuthorityGrabLandlord_Ntt = 128;
		 public const ushort Actor_GamerGrabLandlordSelect_Ntt = 129;
		 public const ushort Actor_SetLandlord_Ntt = 130;
		 public const ushort Actor_AuthorityPlayCard_Ntt = 131;
		 public const ushort Actor_SetMultiples_Ntt = 132;
	}
}
